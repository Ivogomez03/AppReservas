...
const ModificarAulaInformatica = () => {
    ...
    const aulaInformatica = location.state?.aula;
    console.log("El aula es ", aulaInformatica);
    ...
    useEffect(() => {
        if (aulaInformatica) {
            setForm({
                numeroDeAula: aulaInformatica.numeroDeAula || '',
                piso: aulaInformatica.piso || '',
                capacidad: aulaInformatica.capacidad || '',
                cantidadDeComputadoras: aulaInformatica.cantidadDeComputadoras || '',
                canion: aulaInformatica.canion || false,
                tipoPizarron: aulaInformatica.tipoPizarron || '',
                aireAcondicionado: aulaInformatica.aireAcondicionado || false,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`/modificarAula`, {
                ...
                body: JSON.stringify({ ...form, tipoAula: aulaInformatica.tipoAula }),
            });
    ...
    return (
        <div className="containerModAulaM">
            <div className="panel-izquierdo-mod-aula-m">
                ...
                <h1>Modificar Aula Informatica</h1>
            ...
            <form onSubmit={handleSubmit} className="formularioModAulaM">
                ...
                <div className="checkbox-container">
                    {["canion", "aireAcondicionado"].map((name) => (
                        <button
                            key={name}
                            type="button"
...
export default ModificarAulaInformatica;
